    ...
    <div className="container mx-auto p-4">
        ...
        {items.map((item, index) => (
          ...
          >
            <div className="shadow-lg">
              <div className="relative w-full h-60 md:h-72 lg:h-80"> {/* Ajusta el tamaño de las imágenes */}
                <Image
      ...
      <AnimatePresence>
        {modalOpen && (
          ...
          >
            <motion.div className="relative top-20 mx-auto p-5  w-96 shadow-lg rounded-md bg-gradient-primary">
